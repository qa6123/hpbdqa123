...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Click để xem lí do " + "<br/>" + "<br/>"  + "💓 anh đang đập nhanh " + "x"+(thePercent+899) + " nè ^^";
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-body').innerHTML = 'Anh yêu thương bảo bối rất nhiều á <i class="fas fa-heart"></i> ';
